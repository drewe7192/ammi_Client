...
export const SpinnerPageHeaderMobile = (props: any) => {
  let chuck = 3;
...
export const SpinnerPageBodyMobile = (props: any) => {
  return (
    <>
...
export const SpinnerPageMobile = () => {
  useEffect(() => {
    setTimeout(() => {
      setisLoading(false);
    }, 3000);
    ...
    <>
      <div className={styles.gridContainer}>
        <div className={styles.gridItem2}>
          <HeaderContainer whichPage="spinnerPage" isMobile={true} />
        </div>
        <div className={styles.gridItem}>
          <BodyContainer whichPage="spinnerPage" isMobile={true} />
        </div>
      </div>
    </>
  );
